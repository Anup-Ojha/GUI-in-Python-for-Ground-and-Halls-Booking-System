...
frame5 = Frame(root, width=1400, height=750, background="#669999")
frame5.place(x=0, y=0)
frame2 = Frame(root, width=1000, bd=4, height=600, bg="white")
...
frame4 = Frame(frame2, width=900, height=300, bg="#80BD9E")
...
goto_menu.add_command(label="CONTACT NO",command=our_command)
...
anup = StringVar()
ojha = StringVar()
anu = tk.Label(frame1, text="WELCOME TO BOOKER ", font=('Helvatica bold', 50), bg="BLUE", fg="RED")
anu.place(y=20, x=120)
...
citylabel=Label(frame2,border=5,height=0,width=5,font=("Helvatica bold",15), relief=tk.RIDGE,fg="black",bg='skyblue',text='CITY').place(y=75,x=220)
monthlabel=Label(frame2,border=5,height=0,width=7,font=("Helvatica bold",15),fg="black", relief=tk.RIDGE,bg='skyblue',text='MONTH').place(y=75,x=360)
datelabel=Label(frame2,border=5,height=0,width=5,font=("Helvatica bold",15),fg="black", relief=tk.RIDGE,bg='skyblue',text='DATE').place(y=75,x=480)
yearlabel=Label(frame2,border=5,height=0,width=5,font=("Helvatica bold",15),fg="black", relief=tk.RIDGE,bg='skyblue',text='YEAR').place(y=75,x=575)
...
frame6 = Frame(frame5, height=600, width=1000, background="white")
